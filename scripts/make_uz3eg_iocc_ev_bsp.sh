...
#  Module Name:         make_uz3eg_iocc_ev_bsp.tcl
...
HDL_HARDWARE_NAME=uz3eg_iocc_ev_hw
HDL_PROJECT_NAME=uz3eg_iocc_ev
...
petalinux_project_configure_devicetree ()
{
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/device-tree/system-user.dtsi.${HDL_PROJECT_NAME} ]
    ...
    ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/device-tree/files/.
    cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/device-tree/uz3eg_iocc_ev_flir_lepton.dtsi \
    ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/device-tree/files/.
    cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/device-tree/uz3eg_iocc_ev_tdm114_cam1.dtsi \
    ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/device-tree/files/.
    cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/device-tree/uz3eg_iocc_ev_tdm114_cam2.dtsi \
    ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/device-tree/files/.
    ...
    echo "	file://uz3eg_iocc_ev_tdm114_cam2.dtsi \ " >> ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/device-tree/device-tree-generation_%.bbappend
...
main_make_function ()
{
  ...
  PETALINUX_PROJECT_NAME=uz3eg_iocc_ev_2017_2
  create_petalinux_bsp
